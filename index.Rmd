...
<div style="text-align:center; margin-top: 1em;">
  <button onclick="resetRegistro()">Reset</button>
</div>
...
function generateRegistro() {
  ...
  tableHTML += `
    <tr>
      <th>Blocco Caldaia</th>
      <th>Pastiglie Zanzare</th>
    </tr>
  `;
  ...
  for (let i = 0; i < 15; i++) {
    ...
    const val1 = localStorage.getItem(id1) || today;
    const val2 = localStorage.getItem(id2) || today;
...
function resetRegistro() {
  for (let i = 0; i < 15; i++) {
    localStorage.removeItem(`registro-caldaia-${i}`);
    localStorage.removeItem(`registro-zanzare-${i}`);
  }
  generateRegistro();
}
