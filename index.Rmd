...
```{r, echo=FALSE, ft.arraystretch = 1, results='asis'}
set_flextable_defaults(fonts_ignore=TRUE)

for(i in names(tabelle_formattate[[1]])){
  cat(paste0("#### ", i, "\n\n"))
  print(tabelle_formattate[[1]][[i]])
  cat("\n\n")
}
...
for(i in names(tabelle_formattate[[2]])){
  cat(paste0("#### ", i, "\n\n"))
  print(tabelle_formattate[[2]][[i]])
  cat("\n\n")
}
